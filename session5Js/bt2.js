...
let lateBooks = [];
let numberOfBook = Number(prompt("Hôm nay có bao nhiêu cuốn sách bị trả muộn?"));
...
for (let i = 1; i < lateBooks.length; i++) {
    console.log(i + " - " + lateBooks[i]);
}
let countLongName = 0;
...
console.log("Số sách có tên dài hơn 20 ký tự: " + countLongName);
